...
<div class="page-header header-filter" data-parallax="true" style="background-image: url('public/img/bg5.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-md-8 ml-auto mr-auto text-center">
                ...
                <br />
                <a href="#pablo" class="btn btn-rose btn-round btn-lg"> <i class="material-icons">format_align_left</i> Read Article </a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="#pablo" class="btn btn-twitter btn-round float-right"> <i class="fab fa-twitter"></i> Twitter</a>
                            <a href="#pablo" class="btn btn-facebook btn-round float-right"> <i class="fab fa-facebook"></i> Facebook</a>
                        </div>
                    </div>
                    <hr />
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img" src="public/img/faces/card-profile1-square.jpg" />
                                    </a>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="public/img/examples/blog6.jpg" />
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="public/img/examples/blog8.jpg" />
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-header card-header-image">
                                <a href="#pablo">
                                    <img class="img img-raised" src="public/img/examples/blog7.jpg" />
                                </a>
                            </div>
                            <div class="card-body">
                                <h6 class="category text-danger"><i class="material-icons">trending_up</i> Enterprise</h6>
                                <h4 class="card-title">
